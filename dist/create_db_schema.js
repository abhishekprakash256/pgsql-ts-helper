...
const connector_sql_1 = require("./connector_sql"); // Import client  
function setupDatabase() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield connector_sql_1.client.query(`
        ...
        `);
            ...
            yield connector_sql_1.client.end();
        }
    });
}
//export { setupDatabase };
setupDatabase();
//# sourceMappingURL=create_db_schema.js.map